...
<div class="col-lg-12">
	<div class="card card-outline card-success">
		<div class="card-header">
			...
			?>
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_issue"><i class="fa fa-plus"></i> Add New Department</a><?php }?>
		...
		<div class="card-body" id="printlist">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					$qry = $conn->query("SELECT * FROM issue_log where   IT_staff_ass = '".$_SESSION['login_staff_id']."' OR reassigned_IT_staff = '".$_SESSION['login_staff_id']."'");
