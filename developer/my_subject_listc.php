		...
		<div class="card-body" id="printlist">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					$qry = $conn->query("SELECT islog.*, us2.firstname, us2.firstname, us2.othername, us2.surname  from issue_log islog JOIN users2 us2 ON islog.status = 'Closed' AND islog.IT_staff_ass = us2.staff_id AND  us2.my_manager = '".$_SESSION['login_staff_id']."'");
