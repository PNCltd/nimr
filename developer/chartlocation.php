...
<!--    <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>-->
    ...
    <script type="text/javascript">
	  ...
	  <?php 
            ...
            echo "['All Issues within the Period', ".intval($_SESSION["rowall"])."],\n";
		    echo "['Closed Issues within the Period', ".intval($_SESSION["rowclosed"])."],\n";
		    echo "['Open Issues within the Period', ".intval($_SESSION["rowopen"])."],\n";
		  	echo "]);"
