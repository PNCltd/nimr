...
$staff_id = $row['staff_id'];
		...
		$to = $email;
			...
			<h4><a href='http://www.ptmfb.pncitservdesk.com/reset.php?staff_id=$staff_id&code=$code'>Reset my Password</h4>
		...
		//dont forget to include content-type on header if your sending html
			...
			$headers .= "From: ochaijohnben@gmail.com". "\r\n" .
						"BC: info@ptmfb.pncitservdesk.com";
