...
<div class="col-lg-12">
	<div class="card card-outline card-success">
		<div class="card-header">
			...
			?>
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_issue"><i class="fa fa-plus"></i> Add New Location</a><?php };
				?>
		...
		<div class="card-body" id="printlist">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					$qry = $conn->query("SELECT * FROM issue_log where status = 'Open' and (IT_staff_ass = '".$_SESSION['login_staff_id']."' OR reassigned_IT_staff = '".$_SESSION['login_staff_id']."')");
...
<?php echo ucwords  ($row2['firstname'].' '.$row2['othername'].' '.$row2['surname']) ?>	<?php endwhile; ?>
						...
						<td class="text-center">
	                      ...
	                      <div class="dropdown-divider"></div>
		                      <a class="dropdown-item" href="./index.php?page=attend_issue&id=<?php echo $row['id'] ?>">Attend to Issue</a>
<!--
		                      <div class="dropdown-divider"></div>
		                      <a class="dropdown-item" href="./index.php?page=reassign_issue&id=<?php // echo $row['id'] ?>">Reassign the issue</a>
-->
