		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					$qry = $conn->query("SELECT * FROM issue_log where IT_staff_ass != 'Not Assigned' ORDER by date_reported DESC");
...
<?php echo ucwords  ($row2['firstname'].' '.$row2['othername'].' '.$row2['surname']) ?>	<?php endwhile; ?>
						...
						<td class="text-center">
	                      ...
	                      <div class="dropdown-divider"></div>
	                       <a class="dropdown-item" href="./index.php?page=reassign_issue&id=<?php echo $row['id'] ?>">Re-assign IT Staff</a>
