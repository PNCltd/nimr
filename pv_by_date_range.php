<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-body">
			<form action="" id="manage-daterange_pv">
        <input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="" class="control-label">Select PV Category</label>
...
-->
    	...
    	<div class="card-footer border-top border-info">
    		<div class="d-flex w-100 justify-content-center align-items-center">
    			<button class="btn btn-flat  bg-gradient-primary mx-2" form="manage-daterange_pv">Search</button>
...
<script>
	...
	$('#manage-daterange_pv').submit(function(e){
		e.preventDefault()
		start_load()
		$.ajax({
			url:'ajax.php?action=save_search_pv',
			...
			success:function(resp){
				if(resp == 1){
					...
					setTimeout(function(){
						location.href = 'index.php?page=pv_detailed_reports'
					},2000)
				}
			}
		})
