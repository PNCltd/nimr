...
if($action == 'save_subhead'){
	$save = $crud->save_subhead();
	if($save)
		echo $save;
}
...
if($action == 'edit_subhead'){
	$save = $crud->edit_subhead();
	if($save)
		echo $save;
	}
...
if($action == 'save_attend'){
	...
	if($action == 'save_attend_a'){
	$save = $crud->save_attend_a();
	if($save)
		echo $save;
	}

	if($action == 'save_attend_pv'){
	$save = $crud->save_attend_pv();
	if($save)
		echo $save;
	}
...
if($action == 'delete_head'){
	$save = $crud->delete_head();
	if($save)
		echo $save;
}

if($action == 'delete_subhead'){
	$save = $crud->delete_subhead();
	if($save)
		echo $save;
}
...
if($action == 'save_search_pv'){
	$save = $crud->save_search_pv();
	if($save)
		echo $save;
}
