...
<!--                <input type="hidden" name="time" value="<?php //echo isset($time) ? $time : '' ?>">-->
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control form-control-sm" name="head" value="<?php echo isset($head) ? $head : '' ?>" required>
						</div>
					</div>
				</div>
    	...
    	<div class="card-footer border-top border-info">
    		<div class="d-flex w-100 justify-content-center align-items-center">
    			<button class="btn btn-flat  bg-gradient-primary mx-2" form="manage-head">Save</button>
...
<script>
	...
	$('#manage-head').submit(function(e){
		e.preventDefault()
		start_load()
		$.ajax({
			url:'ajax.php?action=save_head',
