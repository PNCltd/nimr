...
<!--	        <input type="hidden" name="manager" value="<?php //echo //isset($row['staff_id']) ? $row['staff_id'] : '' ?>">-->
	...
	<div class="form-group">
		...
		<select name="my_manager" id="my_manager" type="select" class="form-control form-control-sm" required>
...
<!--	        <input type="hidden" name="manager" value="<?php //echo //isset($row['staff_id']) ? $row['staff_id'] : '' ?>">-->
	...
	<div class="form-group">
							<label for="" class="control-label">Staff to be assigned.</label>
		<select name="staff_id" id="staff_id" type="select" class="form-control form-control-sm" required>
...
<script>
	...
	$('#manage_managers').submit(function(e){
		...
		start_load()
		$.ajax({
			url:'ajax.php?action=save_managers',
